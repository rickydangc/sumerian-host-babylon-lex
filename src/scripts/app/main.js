...
import { SumerianHostUtils } from '../lib/sumerian-host-utils';
...
// TODO: This code assumes you've assigne the managed permission policies below
// to the Amplify app's unathenticated user role (usually ending in the
// suffix "Unauth_Role"):
...
async function configureAwsSdk() {
  ...
  // Use services in the same region as this Amplify app's Cognito ID.
  AWS.config.region = credentials.identityId.split(':')[0];
